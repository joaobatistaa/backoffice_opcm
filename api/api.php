<?php
	...
	class API extends REST {
		...
		*/
		...
		private function get_events_detail() {
	        $this->functions->getEventsById();
	    }
		
		private function get_recent_events() {
			$this->functions->getRecentEvents();
		}
		
		private function get_postevent_detail() {
	        $this->functions->getEventsDetail();
	    }
	    ...
	    private function get_our_mission() {
	        $this->functions->getOurMission();
	    }
