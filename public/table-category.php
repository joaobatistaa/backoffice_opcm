...
?>
    ...
    <section class="content">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Categorias</a></li>
        </ol>
                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <div class="header-dropdown m-r--5">
                                <a href="add-category.php"><button type="button" class="btn bg-blue waves-effect">Adicionar Categoria</button></a>
                            </div>
                        </div>
                        ...
                        <div class="body table-responsive">
	                        ...
	                        <form method="get">
	                        	<div class="col-sm-10">
									<div class="form-group form-float">
										<div class="form-line">
											<input type="text" class="form-control" name="keyword" placeholder="Pesquisar por categorias...">
										</div>
									</div>
								</div>
								<div class="col-sm-2">
							...
							<div class="col-sm-10">Wopps! Nenhuma categoria encontrada.</div>
									...
									while ($stmt_paging->fetch()) { ?>
										<tr>
											...
											<td>
									            ...
									            <a href="delete-category.php?id=<?php echo $data['cid'];?>" onclick="return confirm('Tens a certeza que pretendes eliminar esta categoria?')" >
