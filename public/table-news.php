                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <div class="header-dropdown m-r--5">
                                <a href="add-news.php"><button type="button" class="btn bg-blue waves-effect">Adicionar Notícia</button></a>
                            </div>
                        </div>
                        ...
                        <div class="body table-responsive">
							...
							<table class='table table-hover table-striped'>
								<thead>
									<tr>
										<th width="40%">Título da Notícia</th>
										<th width="15%">Imagem da Notícia</th>
										<th width="15%">Data</th>
							...
							<div class="col-sm-10">Wopps! Nenhuma notícia encontrada.</div>
                        ...
                        <div class="body table-responsive">
	                        ...
	                        <form method="get">
	                        	<div class="col-sm-10">
									<div class="form-group form-float">
										<div class="form-line">
											<input type="text" class="form-control" name="keyword" placeholder="Pesquisar por título da notícia...">
										</div>
									</div>
								</div>
								<div class="col-sm-2">
							...
							<table class='table table-hover table-striped'>
								<thead>
									<tr>
										<th width="40%">Título da Notícia</th>
										<th width="12%">Imagem da Notícia</th>
										<th width="12%">Data</th>
										...
										<tr>
											...
											<td>
                                                <?php if ($data['content_type'] == 'Post') { ?>
                                                    <span class="label bg-green">NOTICIA</span>
                                                 <?php } else { ?>
                                                    <span class="label bg-red">VIDEO</span>
                                                <?php } ?>	
											</td>
											<td><center>
												<a href="manage-news.php?send_notification_post=<?php echo $data['nid'];?>" onclick="return confirm('Enviar notificação para todos os utilizadores?')">
									            ...
									            <a href="delete-news.php?id=<?php echo $data['nid'];?>" onclick="return confirm('Tens a certeza que pretendes eliminar esta notícia?')" >
