<?php 
		...
		$sql_query2 = "SELECT * FROM tbl_news n, tbl_comments c, wpe4_users u WHERE n.nid = c.nid AND c.user_id = u.ID AND n.nid = '".$_GET['id']."'";
	...
	<section class="content">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Detalhes da Notícia</a></li>
        </ol>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                	...
                	<div class="card">
                        ...
                        <div class="body">
                        	...
                        	<div class="form-group form-float col-sm-12">
                        		<p>
									<h4>
										...
										<a href="delete-news.php?id=<?php echo $data['nid'];?>" onclick="return confirm('Tens a certeza que pretendes eliminar esta noticia?')" ><i class="material-icons">delete</i></a>
									</h4>
								</p>
								<p>
								...
								<hr>
							<p><b>Comentários ( <?php echo $total_comments;?> )</b></p>
							<?php
								$total = 0;
							...
							<table>
								<tr>
									<td><b><?php echo $data2['display_name']; ?></b></td>
									<td><a href="delete-comment.php?id=<?php echo $data2['comment_id'];?>" onclick="return confirm('Tens a certeza que pretendes eliminar este comentário?')" ><i class="material-icons">delete</i></a></td>
								</tr>
