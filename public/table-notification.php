...
?>
    ...
    <section class="content">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Notificações</a></li>
        </ol>
                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <div class="header-dropdown m-r--5">
                                <a href="add-notification.php"><button type="button" class="btn bg-blue waves-effect">Adicionar Notificação</button></a>
                            </div>
                            <br>
                        ...
                        <div class="body table-responsive">
                            ...
                            <div class="col-sm-10">Wopps! Nenhuma notificação encontrada.</div>
                                ...
                                <?php 
                                    while ($stmt_paging->fetch()) { ?>
                                        <tr>
                                            ...
                                            <a href="push-notification.php?send_notification_info=<?php echo $data['id'];?>" onclick="return confirm('Enviar esta notificação para todos os utilizadores?')">
                                            ...
                                            <a href="push-notification.php?id=<?php echo $data['id'];?>" onclick="return confirm('Tens a certeza que pretendes eliminar esta notificação?')">
