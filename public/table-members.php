 ...
 ?>
    ...
    <section class="content">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Administradores</a></li>
        </ol>
                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <div class="header-dropdown m-r--5">
                                <a href="add-member.php"><button type="button" class="btn bg-blue waves-effect">Adicionar Administrador</button></a>
                            </div>
                        </div>
                        ...
                        <div class="body table-responsive">
                            ...
                            <form method="get">
                                <div class="col-sm-10">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="keyword" placeholder="Pesquisar por nome de utilizador...">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-2">
                            ...
                            <div class="col-sm-10">Wopps! Nenhum administrador encontrado.</div>
                                    ...
                                    while ($stmt_paging->fetch()) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                ?>
                                                    <a href="members.php?id=<?php echo $data['id'];?>" onclick="return confirm('Tens a certeza que pretendes eliminar este utilizador?')" >
