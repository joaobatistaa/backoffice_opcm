...
EOF;
    ...
    <section class="content">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="push-notification.php">Notificações</a></li>
            <li class="active">Editar Template de Notificações</a></li>
        </ol>
       ...
       <div class="container-fluid">
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>Editar Template de Notificações</h2>
                            ...
                            <div class="row clearfix">
                                ...
                                <div>
                                    <div class="form-group col-sm-12">
                                        <div class="form-line">
                                            <div class="font-12">Mensagem</div>
                                    ...
                                    <div class="form-group col-sm-12">
                                        <div class="form-line">
                                            <div class="font-12">URL (Opcional)</div>
