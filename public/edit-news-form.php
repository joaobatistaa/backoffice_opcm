...
$(document).ready(function(e) {
   ...
   <section class="content">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Editar Notícia</a></li>
        </ol>
                        ...
                        <div class="header">
                            <h2>Editar Notícia</h2>
                                <?php if(isset($_SESSION['msg'])) { ?>
                                    <br><div class='alert alert-info'>Notícia editada com sucesso...</div>
                                ...
                                <div class="col-sm-5">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control show-tick" name="upload_type" id="upload_type">
                                        	<option <?php if($row['content_type'] == 'Post'){echo 'selected';} ?> value="Post">Notícia Normal</option>
										    <option <?php if($row['content_type'] == 'youtube'){echo 'selected';} ?> value="youtube">Vídeo do YouTube</option>
										    <option <?php if($row['content_type'] == 'Url'){ echo 'selected';} ?> value="Url">Vídeo por URL</option>
										    <option <?php if($row['content_type'] == 'Upload'){ echo 'selected';} ?> value="Upload">Carregar Vídeo</option>
                                        </select>
                                    </div>
