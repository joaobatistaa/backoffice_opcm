...
?>
    ...
    <section class="content">
        ...
        <ol class="breadcrumb">
            ...
            <li class="settings.php">Definições</a></li>
            <li class="active">Editar Chave API</a></li>
        </ol>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <form method="post" enctype="multipart/form-data">
                        <div class="card">
                            <div class="header">
                                <h2>Editar Chave API</h2>
                                <div class="header-dropdown m-r--5">
                                    <button type="submit" name="submit" class="btn bg-blue waves-effect" onclick="return confirm('Tens a certeza que pretendes editar a chave API?')">Editar Chave API</button>
                                </div>
                                <br>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <div class="form-group">
                                            <div class="form-line">
                                                <div class="font-12">Editar Chave API</div>
